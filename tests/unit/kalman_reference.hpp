#pragma once
// Expanded-component oracle frozen from neo-fft 6e2621c, before state sharing.
// Keep its two independent recurrences to detect changes in binary32 results.
#include "kernels/kalman.hpp"
namespace kalman_reference {
using neo_fft::finite;
